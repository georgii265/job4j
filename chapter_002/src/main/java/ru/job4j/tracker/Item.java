...
public class Item {
     ...
     * Метод setName (имя метода-сеттера тоже состоит из слова set + название переменной)
     * ничего не возвращает (void) но при этом требует String - новое значение для переменной name.
     */
